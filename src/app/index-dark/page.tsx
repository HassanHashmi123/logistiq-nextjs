      ...
      <Header />
                ...
                <div className="banner-one__content">
                    ...
                    <div className="banner-one__content-right wow fadeInRight" data-wow-delay="0ms"
                        ...
                        <div className="banner-one__content-right-btn">
                            <a className="thm-btn" href="/about">About Us
                    ...
                    <div className="service-one__carousel owl-carousel owl-theme owl-dot-style1">
                        ...
                        <div className="service-one__single">
                            <div className="service-one__single-inner">
                                ...
                                <div className="service-one__single-content">
                                    <h2><a href="/international-transport">International Shipping</a></h2>
                        ...
                        <div className="service-one__single">
                            <div className="service-one__single-inner">
                                ...
                                <div className="service-one__single-content">
                                    <h2><a href="/international-transport">Ocean Freight</a></h2>
                                    <p>A logistic service provider company plays
                                        a pivotal role in the global supply chain logistic service.</p>
                                    <div className="btn-box">
                                        <a href="/international-transport">Read More <span
                        ...
                        <div className="service-one__single">
                            <div className="service-one__single-inner">
                                ...
                                <div className="service-one__single-content">
                                    <h2><a href="/international-transport">Rail Freight</a></h2>
                                    <p>
                                        A logistic service provider company plays
                                        a pivotal role in the global supply chain logistic service.
                                    </p>
                                    <div className="btn-box">
                                        <a href="/international-transport">Read More <span
                                                className="icon-right-arrow21"></span></a>
                    ...
                    <div className="col-xl-7">
                        <div className="skill-one__content">
                            ...
                            <div className="skill-one__content-btn">
                                <a className="thm-btn" href="/about">Book Your Parcel
                                    <i className="icon-right-arrow21"></i>
                                    <span className="hover-btn hover-bx"></span>
                                    <span className="hover-btn hover-bx2"></span>
                                    <span className="hover-btn hover-bx3"></span>
        ...
        <section className="features-two">
            <div className="features-two__top">
                <div className="container">
                    <div className="features-two__top-inner">
                        ...
                        <div className="btn-box">
                            <a className="thm-btn" href="/about">Our Solutions
                                <i className="icon-right-arrow21"></i>
                                <span className="hover-btn hover-bx"></span>
                                <span className="hover-btn hover-bx2"></span>
                                <span className="hover-btn hover-bx3"></span>
            ...
            <div className="container-fluid">
                <div className="features-two__carousel owl-carousel owl-theme">
                        ...
                        <div className="features-two__single-img">
                            <div className="features-two__single-img-inner">
                                ...
                                <div className="features-two__single-content">
                                    ...
                                    <h2><a href="#">Aviation Freight</a></h2>
                                    ...
                                    <div className="features-two__single-content-bottom">
                                        ...
                                        <div className="btn-box">
                                            <a href="#"><span className="icon-right-arrow21"></span></a>
                                        </div>
                                    </div>
                    ...
                    <div className="features-two__single">
                        <div className="features-two__single-img">
                            <div className="features-two__single-img-inner">
                                <img src="/assets/images/resources/features-v2-img4.jpg" alt="" />

                                <div className="features-two__single-content">
                                    <span>Trucks & Lorries</span>
                                    <h2><a href="#">Roadway Cargo</a></h2>
