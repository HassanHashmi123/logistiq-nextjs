                    ...
                    <div className="col-xl-8">
                        <div className="row">
                                ...
                                <div className="blog-one__single">
                                    ...
                                    <div className="blog-one__single-content">
                                        ...
                                        <div className="blog-one__single-content-inner">
                                            ...
                                            <h2><a href="/blog-details">How Will You Know Success <br /> When it Show
                                                    Up?</a></h2>
                                ...
                                <div className="blog-one__single">
                                    ...
                                    <div className="blog-one__single-content">
                                        ...
                                        <div className="blog-one__single-content-inner">
                                            ...
                                            <h2><a href="/blog-details">Mastering Last Mile Delivery <br /> Strategies
                                                    for Success</a>
                                            </h2>
                                            <p>Logistic service provider company plays a pivotal role in the global
                                                supply chain ecosystem by efficiently... </p>
                                ...
                                <div className="blog-one__single">
                                    ...
                                    <div className="blog-one__single-content">
                                        ...
                                        <div className="blog-one__single-content-inner">
                                            ...
                                            <h2><a href="/blog-details">Logistics Announces Launch <br /> of
                                                    Greenhouse Gas</a></h2>
                                            <p>Logistic service provider company plays a pivotal role in the global
                                                supply chain ecosystem by efficiently... </p>
                            ...
                            <ul className="styled-pagination text-center clearfix">
                                <li className="arrow prev active"><a href="#"><span className="icon-right-arrow3"></span></a>
                                </li>
                                <li><a href="#">1</a></li>
                                <li><a href="#">2</a></li>
                                <li><a href="#">3</a></li>
                                <li className="arrow next"><a href="#"><span className="icon-right-arrow31"></span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
