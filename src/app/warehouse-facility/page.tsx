...
export default function WarehouseFacility() {
  return (
    <>
      <Header />
                            ...
                            <div className="service-details__sidebar-single">
                                ...
                                <div className="service-details__sidebar-single-service">
                                    <ul className="clearfix">
                                        <li><a href="/international-transport">International Transport <span
                                                    className="icon-right-arrow21"></span></a></li>

                                        <li><a href="/track-transport">Local Track Transport <span
                                                    className="icon-right-arrow21"></span></a></li>

                                        <li><a href="/personal-delivery">Fast Personal Delivery <span
                                                    className="icon-right-arrow21"></span></a></li>

                                        <li><a href="/ocean-transport">Safe Ocean Transport <span
                                                    className="icon-right-arrow21"></span></a></li>

                                        <li><a className="active" href="#">Warehouse Facility <span
                                                    className="icon-right-arrow21"></span></a>
                                        </li>

                                        <li><a href="/emergency-transport">Emergency Transport <span
                                                    className="icon-right-arrow21"></span></a>
                                        </li>
                                    </ul>
                                </div>
                                        ...
                                        <li>
                                            <div className="content-box">
                                                ...
                                                <div className="text-box">
                                                    <h2><a href="#">Pdf Download</a></h2>
                                                    <p><a href="#">Download</a></p>
                                                </div>
                                            </div>

                                            <div className="btn-box">
                                                <a href="#"><span className="icon-download"></span></a>
                                            </div>
                                        </li>
