...
export default function HeroBanner() {
  return (
    <section className="banner-one">
            ...
            <div className="banner-one__img1"><img className="float-bob-x" src="/assets/images/banner/banner-v1-img1.png" alt="#" /></div>
            <div className="banner-one__img5"><img className="float-bob-y" src="/assets/images/banner/banner-v1-img5.png" alt="#" /></div>
