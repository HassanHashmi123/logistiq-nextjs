            ...
            <div className="row">
              <div className="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                <div className="footer-widget__single footer-one__about">
                  ...
                  <p className="footer-one__about-text">Logistic service provider company plays a pivotal role in the global supply chain logistic service provider.</p>
              ...
              <div className="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                <div className="footer-widget__single footer-one__quick-links">
                  ...
                  <ul className="footer-one__quick-links-list">
                    ...
                    <li><Link href="/service"><span className="icon-right-arrow1"></span> Service</Link></li>
                    <li><Link href="/project"><span className="icon-right-arrow1"></span> Latest Project</Link></li>
                    <li><Link href="/contact"><span className="icon-right-arrow1"></span> Contact Us</Link></li>
                  </ul>
                </div>
              </div>
              ...
              <div className="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                <div className="footer-widget__single footer-one__subscribe">
                  ...
                  <p className="footer-one__subscribe-text">Sign up for alerts, our latest blogs, <br /> thoughts, and insights</p>
        ...
        <div className="container">
          <div className="footer-one__bottom-inner">
            <div className="footer-one__bottom-text">
              <p>© Copyright 2025 <Link href="/">Logistiq.</Link> All Rights Reserved</p>
            </div>
